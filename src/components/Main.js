    ...
    return (
      <div id="main" style={props.timeout ? { display: 'flex' } : { display: 'none' }}>
        <article id="about" className={`${props.article === 'about' ? 'active' : ''} ${props.articleTimeout ? 'timeout' : ''}`} style={{ display: 'none' }}>
          ...
          <p>Isaiah Mason is a licensed real estate broker with a robust background in the recreational vehicle sales industry. Most recently, he served as the general manager for a dealership, overseeing operations at two locations. This experience honed his leadership skills and provided him with valuable insights into customer service, negotiation, and sales strategy.</p>
          <p>Isaiah has chosen to partner with Windermere Country Roads because of their unwavering commitment to clients, dedication to giving back to the community, and their focus on doing what is right. While being new to real estate can present challenges, he has surrounded himself with a supportive team that offers over 50 years of combined knowledge and experience.</p>
          <p>As he transitions into real estate, Isaiah is dedicated to helping clients navigate the complexities of buying and selling properties, ensuring each transaction is smooth and successful. He understands the importance of building meaningful relationships with clients and is passionate about helping them achieve their real estate goals. His aspiration is to become a trusted name in the real estate industry and to actively contribute to the development of the Prineville community.</p>
